...
function ReadReceipt({ readBy, myId }) {
  // readBy contains the sender + anyone who has read it
...
// ── Main component ────────────────────────────────────────
export default function MessageBubble({ message, isOwn, showAvatar, myId }) {
  const { sender, content, type, fileUrl, fileName, readBy, createdAt } = message
  ...
  return (
    <div className="flex items-end gap-2 mb-1 group">
      {/* Fixed-width avatar slot keeps received bubbles aligned */}
